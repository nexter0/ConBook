...
namespace ConBook {
  public partial class MainForm : Form, IMainComponents {
    ...
    przenieś kod z funkcji ze zdarzeniami do osobnych nowych funkcji 
      poniższa funkcja zdarznia powinna jedynie wywoływac funkcję np. SortList()
    ...
    private void MainForm_Load(object sender, EventArgs e) {
      ...
      rób przerwy pomiędzy blokami, trudno się czyta kod który leci ciurkiem
        tutaj jeszcze bede Ci pokazywał wiele miejsc jak to powinno byc zorganizowane
